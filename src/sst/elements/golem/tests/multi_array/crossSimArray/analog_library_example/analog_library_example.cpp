...
int main() {
    ...
    AnalogMatrix<float> analog_matA(matA, rows, cols);
    AnalogVector<float> analog_vecA(vecA, cols);
    AnalogVector<float> analog_vecA_out(outA, rows); 

    AnalogMatrix<float> analog_matB(matB, rows, cols);
    AnalogVector<float> analog_vecB(vecB, cols);
    AnalogVector<float> analog_vecB_out(outB, rows); 
