...
class EmulatedFloatMVMArray : public EmulatedComputeArray<float> {
public:
    SST_ELI_REGISTER_SUBCOMPONENT(
        EmulatedFloatMVMArray,
        "golem",
        "EmulatedFloatMVMArray",
    ...
    EmulatedFloatMVMArray(ComponentId_t id, Params& params,
        TimeConverter* tc,
...
#endif /* _EMULATEDFLOATMVMARRAY_H */
